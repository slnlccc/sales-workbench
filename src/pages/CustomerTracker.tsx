            ...
            <div className="relative">
              <div className="flex items-start justify-between mb-3">
                <div>
                  ...
                  <h1 className="text-2xl font-bold font-display mb-1">{project.name}</h1>
                ...
                <div className="text-right">
                  ...
                  <p className="text-3xl font-bold">¥ {project.amount}<span className="text-sm font-normal">万</span></p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 gap-4 pt-4 border-t border-white/20">
                <div>
                  ...
                  <p className="text-xl font-bold mt-1">{project.progress}%</p>
                </div>
                <div>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-soft">
        <div className="flex items-center gap-4 mb-5">
          ...
          <div className="flex-1">
            <h3 className="text-xl font-bold text-coffee-900 font-display">{customer.name}</h3>
