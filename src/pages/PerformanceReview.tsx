    ...
    <Layout>
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-xl font-bold text-coffee-900 font-display">业绩复盘</h1>
          ...
          <div className="grid grid-cols-4 gap-3 mb-5">
            <div className="bg-white rounded-2xl p-4 shadow-soft">
              ...
              <p className="text-2xl font-bold text-coffee-900">500<span className="text-sm font-normal text-coffee-500">万</span></p>
            </div>
            <div className="bg-white rounded-2xl p-4 shadow-soft">
              <div className="flex items-center justify-between mb-2">
              ...
              <p className="text-2xl font-bold text-coffee-900">425<span className="text-sm font-normal text-coffee-500">万</span></p>
            </div>
            <div className="bg-white rounded-2xl p-4 shadow-soft">
              <div className="flex items-center justify-between mb-2">
              ...
              <p className="text-2xl font-bold text-amber-600">85<span className="text-sm font-normal">%</span></p>
            </div>
            <div className="bg-white rounded-2xl p-4 shadow-soft">
              <div className="flex items-center justify-between mb-2">
              ...
              <p className="text-2xl font-bold text-emerald-600">21.4<span className="text-sm font-normal">%</span></p>
            </div>
          </div>
