    ...
    <Layout>
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-lg md:text-xl font-bold text-coffee-900 font-display">报告生成</h1>
          ...
          {generatedReport ? (
            ...
            <>
              ...
              >
                ...
                <h3 className="text-lg md:text-xl font-semibold text-coffee-900 mb-2">选择报告类型开始生成</h3>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
                  <div className="bg-cream rounded-xl p-3 text-center">
                    ...
                    <input
                      ...
                      className="w-full text-center text-base md:text-lg font-bold text-coffee-900 bg-transparent focus:outline-none"
                    />
        ...
        >
          ...
          >
            <div className="p-6 border-b border-coffee-100 text-center">
              <h3 className="text-lg md:text-xl font-semibold text-coffee-900 font-display mb-1">选择报告类型</h3>
