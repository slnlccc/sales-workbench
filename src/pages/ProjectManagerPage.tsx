    ...
    <Layout>
          ...
          <div className="mb-5">
            <div className="flex items-center gap-2 mb-1">
              ...
              <h1 className="text-xl font-semibold text-coffee-900 font-display">项目管家</h1>
            </div>
          ...
          {activeTab === 'project' && (
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-8 pr-3 py-2 rounded-lg border border-coffee-200 bg-white text-sm text-coffee-800 placeholder:text-coffee-400 focus:outline-none focus:ring-2 focus:ring-coffee-300 w-64"
                  />
                </div>
                <select
              ...
              {/* Statistics */}
              <div className="flex items-center gap-4 text-sm text-coffee-700 bg-white border border-coffee-200 rounded-xl px-4 py-3 shadow-soft">
    ...
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white rounded-2xl shadow-card max-w-3xl w-full max-h-[85vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        <div className="px-6 py-4 border-b border-coffee-100 flex items-center justify-between sticky top-0 bg-white">
          <div>
            <h2 className="text-lg font-semibold text-coffee-900 font-display">项目详情</h2>
    ...
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white rounded-2xl shadow-card max-w-4xl w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        <div className="px-6 py-4 border-b border-coffee-100 flex items-center justify-between sticky top-0 bg-white z-10">
          <h2 className="text-lg font-semibold text-coffee-900 font-display">
            {isEdit ? '编辑项目' : '新增项目'}
          </h2>
          <button onClick={onClose} className="p-1.5 rounded-md hover:bg-coffee-50 text-coffee-500">
            <X className="w-4 h-4" />
  ...
  return (
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white rounded-2xl shadow-card max-w-3xl w-full max-h-[85vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        <div className="px-6 py-4 border-b border-coffee-100 flex items-center justify-between sticky top-0 bg-white">
          <div>
            <h2 className="text-lg font-semibold text-coffee-900 font-display">合同详情</h2>
