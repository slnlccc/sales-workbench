    ...
    <div className="space-y-6 animate-fade-in">
          ...
          return (
            ...
            >
              ...
              <div className="flex items-baseline gap-1.5">
                <span className="text-2xl md:text-3xl font-bold text-coffee-900 font-display">
          ...
          {workDistribution.map((item) => {
            ...
            return (
              <div key={item.key} className="flex items-center gap-4">
                <div className="flex items-center gap-2 w-20 md:w-24 text-sm text-coffee-600">
                ...
                <div className="text-sm text-coffee-700 font-medium w-24 md:w-32 text-right">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-gradient-coffee text-white rounded-2xl p-5">
          ...
          <p className="text-xl md:text-2xl font-bold font-display">¥ 35.0万</p>
        ...
        <div className="bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded-2xl p-5">
          ...
          <p className="text-xl md:text-2xl font-bold font-display">5 家</p>
        ...
        <div className="bg-gradient-to-br from-violet-500 to-violet-600 text-white rounded-2xl p-5">
          ...
          <p className="text-xl md:text-2xl font-bold font-display">¥ 7818万</p>
