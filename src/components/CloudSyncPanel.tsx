          ...
          {status?.recordCount && (
            <div className="mt-3 p-3 rounded-xl bg-cream-50">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 text-center">
                <div>
                  <p className="text-base md:text-lg font-semibold text-cream-700">{status.recordCount.projects}</p>
                  <p className="text-xs text-cream-400">项目</p>
                </div>
                <div>
                  <p className="text-base md:text-lg font-semibold text-cream-700">{status.recordCount.contracts}</p>
                  <p className="text-xs text-cream-400">合同</p>
                </div>
                <div>
                  <p className="text-base md:text-lg font-semibold text-cream-700">{status.recordCount.schedules}</p>
                  <p className="text-xs text-cream-400">日程</p>
                </div>
                <div>
                  <p className="text-base md:text-lg font-semibold text-cream-700">{status.recordCount.customers}</p>
